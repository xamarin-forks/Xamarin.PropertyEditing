...
namespace Xamarin.PropertyEditing
{
	internal static class Numeric<T>
	{
		...
		private static Func<T, T> GetNullableVersion (Expression shiftExpression, Type realType)
		{
			...
			var shift = Expression.Invoke (shiftExpression, Expression.Convert (Expression.Call (Expression.Constant (NullConverter), nameof(NullableConverter.ConvertFrom), null, Expression.Convert(v, typeof(object))), realType));
